    ...
    <div class="flex gap1">
      <div class="flex-auto">
        <div class="im-message-right">
          ...
          <p>
            <a href={`https://twitter.com/${content.username}/status/${props.data.id}`} rel="noopener noreferrer nofollow">{date.toISOString()}</a> - <a href={`/json/get/tweet/${props.data.id}`} rel="noopener noreferrer nofollow">as json</a>
          </p>
        </div>
      </div>
      <div class="flex-none">
